  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((v) => !v)}
        className="inline-flex h-7 w-7 items-center justify-center rounded-full text-muted transition-colors hover:bg-brand-50"
      >
        <MoreIcon size={16} />
      </button>
      ...
      {open && (
        <div
          role="menu"
          className="absolute bottom-full right-0 z-20 mb-1 w-40 overflow-hidden rounded-xl border border-line bg-white py-1 shadow-lg"
        >
          <button
            type="button"
            role="menuitem"
